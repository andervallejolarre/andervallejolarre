...
### Learning Exercises
**[Task Manager API (AI Re-Built)](https://github.com/andervallejolarre/task_manager_api_ai)** - Hand-built Task Manager API rebuild with a team of AI coding agents as an experiment in AI-driven development.
